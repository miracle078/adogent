  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-luxury focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-gradient-primary text-primary-foreground hover:shadow-luxury transform hover:scale-105 transition-luxury shadow-elegant",
        premium: "bg-card border border-primary/20 text-foreground hover:bg-gradient-card hover:border-primary/40 shadow-elegant hover:shadow-luxury transition-luxury",
        voice: "bg-primary/20 text-primary hover:bg-primary/30 border border-primary/40 hover:border-primary/60 backdrop-blur-sm shadow-glow"
      },
      size: {
